 ...
 */
public class Batch2017Fragment extends Fragment {


    @BindView(R.id.rvbatch2017)
    RecyclerView rvbatch2017;
    Unbinder unbinder;

    public Batch2017Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_batch2017, container, false);
        ...
        rvbatch2017.setLayoutManager(llm);

        rvbatch2017.setHasFixedSize(true);

        studentAdapter = new StudentAdapter(photo, regnos, names, getContext());

        //rv.setLayoutManager(new LinearLayoutManager(this.getContext()));
        rvbatch2017.setAdapter(studentAdapter);
        return view;
    }
    private void intialiseData() {
        ...
        String[] selectionArgs = new String[]{"2017"};
