 ...
 */
public class Batch2014Fragment extends Fragment {


    @BindView(R.id.rvbatch2014)
    RecyclerView rvbatch2014;
    Unbinder unbinder;

    public Batch2014Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_batch2014, container, false);
        ...
        rvbatch2014.setLayoutManager(llm);

        rvbatch2014.setHasFixedSize(true);

        studentAdapter = new StudentAdapter(photo, regnos, names, getContext());

        rvbatch2014.setAdapter(studentAdapter);
    ...
    private void intialiseData() {
        ...
        String[] selectionArgs = new String[]{"2014"};
