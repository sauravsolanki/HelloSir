 ...
 */
public class Batch2016Fragment extends Fragment {


    @BindView(R.id.rvbatch2016)
    RecyclerView rvbatch2016;
    Unbinder unbinder;

    public Batch2016Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_batch2016, container, false);
        ...
        rvbatch2016.setLayoutManager(llm);

        rvbatch2016.setHasFixedSize(true);

        studentAdapter = new StudentAdapter(photo, regnos, names, getContext());

        //rv.setLayoutManager(new LinearLayoutManager(this.getContext()));
        rvbatch2016.setAdapter(studentAdapter);
    ...
    private void intialiseData() {
        ...
        String[] selectionArgs = new String[]{"2016"};
